...
SECTION_PROVIDER_BINDINGS: tuple[SectionProviderBinding, ...] = (
    ...
    SectionProviderBinding("Risk / Backtest / Monte Carlo", "Shared terminal OHLCV", ("TWELVE_DATA_API_KEY", "ALPHA_VANTAGE_API_KEY", "COINGECKO_DEMO_API_KEY", "COINGECKO_API_KEY"), "Frankfurter / CoinGecko public / Yahoo", "Historical prices and scenarios"),
